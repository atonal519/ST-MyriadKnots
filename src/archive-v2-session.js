...
export function createArchiveV2Session({ contextProvider, isEnabled = true, ensureChatId = ensureChatUuid } = {}) {
  ...
  function prepare() {
    ...
    operation.promise = (async () => {
      try {
        const chatId = await ensureChatId(context.raw, context.host);
