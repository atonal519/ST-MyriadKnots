...
const floor = (id, seq) => ({ id, assistantSeq: seq, hostLocator: { messageIndex: (seq - 1) * 2, swipeId: null, selectedSwipeIndex: null }, content: { rawFingerprint: 'sha256:old', canonicalFingerprint: 'sha256:old' } });
...
test('实体首末楼按全部存活memory/CSE结构化引用投影', () => {
  ...
  const entity = { id: ENTITY, firstSeenFloorId: '33333333-3333-4333-8333-333333333333', lastSeenFloorId: '33333333-3333-4333-8333-333333333333' };
...
test('baseline 保留人物在唯一来源楼删除后清空悬空首末楼', () => {
  ...
  const entity = { id: ENTITY, firstSeenFloorId: deletedFloorId, lastSeenFloorId: deletedFloorId };
